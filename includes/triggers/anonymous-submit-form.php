...
class AutomatorWP_Caldera_Forms_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest submits a form', 'automatorwp-caldera-forms' ),
            'select_option'     => __( 'Guest submits <strong>a form</strong>', 'automatorwp-caldera-forms' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'Guest submits %1$s', 'automatorwp-caldera-forms' ), '{post}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Guest submits %1$s', 'automatorwp-caldera-forms' ), '{post}' ),
